...
Handler.UpdatePlayerScore = function (roleInfo, callback) {
    return this.AddPlayerScore(roleInfo.roleID, roleInfo.chestPoint || 0, callback);
};
...
Handler.GetChart = function (roleID, chartType, callback) {
    ...
    Q.all(jobs)
        .spread(function (rank, score) {
                    myChartID = (rank || 0) + 1;
                    myScore = score;
                    return zRevRange(self.zsetName, 0, defaultValues.chartChestPointTopListCount - 1, 'WITHSCORES');
                })
