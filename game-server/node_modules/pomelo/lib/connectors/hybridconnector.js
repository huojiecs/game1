...
Connector.prototype.start = function(cb) {
  ...
  if(!this.ssl) {
    ...
    this.tcpServer.on('error', function(error) {
        logger.error('tcpServer failed host: %s, port: %s, error: %s', self.host, self.port, error.stack);
//        this.emit('error', error);
    ...
    if(!!this.distinctHost) {
      ...
      this.tcpServer.listen(this.port);
          ...
          logger.error('tcpServer.listen failed: port: %s, host: %s', this.port, this.host)
          throw e;
      }
  } else {
