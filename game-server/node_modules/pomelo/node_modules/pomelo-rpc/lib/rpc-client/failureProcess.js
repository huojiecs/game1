...
var failfast = function(code, tracer, serverId, msg, opts, cb) {
	logger.warn('rpc failed with error, remote server: %s, msg: %j, error code: %s', serverId, msg, code);
	utils.invokeCallback(cb, new Error(util.format('rpc failed with error, remote server: %s, msg: %j, error code: %s', serverId, msg, code)));
};
